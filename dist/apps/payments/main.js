...
/***/ "./apps/payments/src/dto/index.ts":
/*!****************************************!*\
  !*** ./apps/payments/src/dto/index.ts ***!
  \****************************************/
...
__exportStar(__webpack_require__(/*! ./payments-create-charge.dto */ "./apps/payments/src/dto/payments-create-charge.dto.ts"), exports);
...
const dto_1 = __webpack_require__(/*! ./dto */ "./apps/payments/src/dto/index.ts");
...
__decorate([
    ...
    __metadata("design:paramtypes", [typeof (_b = typeof dto_1.PaymentsCreateChargeDto !== "undefined" && dto_1.PaymentsCreateChargeDto) === "function" ? _b : Object]),
...
let PaymentsService = class PaymentsService {
    ...
    async createCharge({ amount, email }) {
        ...
        this.notificationsService.emit("notify_email", {
            ...
            text: `Your payment of $${parseFloat(amount.toFixed(2).toString())} has completed successfully`,
        });
...
bootstrap().then(() => console.info("payment service is bootstrapped and running"));
